...
public class Scp053Ntf : Scp053Component
{
    public override uint Id { get; set; } = 12;
    public override string Name { get; set; } = "SCP-053-NTF";

    public override string Description { get; set; } = "<size=35><color=#005fed>Ты всё ещё <b>SCP-053</color></b>\n" +
