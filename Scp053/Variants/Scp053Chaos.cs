...
public class Scp053Chaos : Scp053Component
{
    public override uint Id { get; set; } = 11;
    public override string Name { get; set; } = "SCP-053-CHAOS";

    public override string Description { get; set; } = "<size=35><color=#028a00>Ты всё ещё <b>SCP-053</color></b>\n" +
                                                       "<color=#00ccff>Игра продолжается!</color></size>";
